    ...
    public static void PrintHelp() {
        ...
        System.out.println(
            String.join(
                ...
                "",
                "    LISTENER MODE",
                "        -M  --multi         Accept all: raw shell, TOMCAT agent, HTTP" + " beacon  [default]",
                ...
                "        -T  --mtls          TOMCAT agent over mTLS  (client cert" + " required)",
                "            --fmtls         Full mTLS on both TCP and HTTPS beacon",
                "",
                "    SERVER",
                "        -S  <host>          Bind host          (default: server.host in" + " server.properties)",
                ...
                "        -TSC                CLI + TeamServer login  — single-operator team" + " mode",
                "        -TSG                GUI + TeamServer login",
                "        -TSW                TeamServer web panel    — multi-operator via" + " HTTP (port: teamserver.port)",
                "        -TC  --teamclient   TeamClient CLI          — connect to -TSW" + " server as operator 2,3,...",
                "                            -ts <host>  TeamServer host (default:" + " web.host)",
                "                            -tp <port>  TeamServer port (default:" + " teamserver.port)",
                "",
                "    AGENT GENERATION",
